...
**Visible app version in `index.html`:** `v1.0.0 · BUILD 20260909.39`  
...
54. iPhone PWA performance pass: AUTO now starts high-DPR iPhones/iPads in LOW instead of MED, targets a mobile-realistic ~45fps, uses lower mobile framebuffer budgets/minimum render scale, disables the expensive windshield refraction pass in LOW, and renders the speed-line HUD canvas at 1× on mobile to avoid wasting Retina fill-rate.
